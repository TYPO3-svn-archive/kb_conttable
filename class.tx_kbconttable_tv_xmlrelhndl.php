 ...
 *
 *
 *   83: class tx_kbconttable_tv_xmlrelhndl
 *  103:     function init($altRoot)
 *  120:     function insertRecord($destination, $row)
...
require_once (PATH_t3lib.'class.t3lib_tcemain.php');
	...
	// Include the new API:
require_once (t3lib_extMgm::extPath('kb_conttable').'class.tx_kbconttable_tv_api.php');
 ...
 * @deprecated	version - 1.0.0
 */
class tx_kbconttable_tv_xmlrelhndl {
	...
	function init($altRoot)	{
		...
		$this->templavoilaAPIObj = $altRoot['table'] ? new tx_kbconttable_tv_api ($altRoot['table']) : new tx_kbconttable_tv_api();
	}
	...
	function insertRecord($destination, $row)	{
		...
		$ret = $this->templavoilaAPIObj->insertElement ($destinationArr, $row);
		return $ret;
	}
