 ...
 *
 *
 *   44: class tx_kbconttable_xmlrelhndl extends tx_templavoila_xmlrelhndl
 *   58:     function pasteRecord($pasteCmd, $source, $destination)
 *  213:     function getRecord($ref)
 *
 * TOTAL FUNCTIONS: 2
...
//		'tt_content' => 'tx_templavoila_flex',
	...
	function init($altRoot)	{
		parent::init($altRoot);
		$this->templavoilaAPIObj->flexFieldIndex = $this->flexFieldIndex;
	}
									...
									switch ($pasteCmd)	{
										case 'copy':
											...
											if ($refID)	{	// Only do copy IF a new element was created.
													// Set the colPos value
												$dataArray = array();
												$dataArray['tt_content'][$refID]['colPos'] = $this->colPos;
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/kb_conttable/class.tx_kbconttable_xmlrelhndl.php'])    {
    include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/kb_conttable/class.tx_kbconttable_xmlrelhndl.php']);
}
